  ...
  */
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$M(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$L(config, 'tickEventName', defaultEventName);
  ...
  */
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$z(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$z(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }
  ...
  var InTouching = /*#__PURE__*/function (_ComponentBase) {
    ...
    function InTouching(gameObject, config) {
      ...
      _this.parent.setInteractive(GetValue$w(config, 'inputConfig', undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
  ...
  var Base = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setName(GetValue$h(config, 'name', ''));
      _this.rexSizer = {};
      _this.space = {};
      ...
      _this.setInnerPadding(GetValue$h(config, 'space', 0));
      var draggable = GetValue$h(config, 'draggable', false);
      if (draggable) {
        _this.setDraggable(draggable);
      }
      _this.setSizerEventsEnable(GetValue$h(config, 'sizerEvents', false));
      _this.setDirty(true);
  ...
  var Sizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function Sizer(scene, x, y, minWidth, minHeight, orientation, config) {
      ...
      _this.setStartChildIndex(GetValue$f(config, 'startChildIndex', 0));
  ...
  */
  ...
  var CreateScrollableSizer = function CreateScrollableSizer(parent, config) {
    ...
    if (child) {
      ...
      if (typeof childSpace !== 'number') {
        ...
        if (scrollMode === 0) {
          childPadding = {
            left: GetValue$4(paddingConfig, 'left', 0),
            right: GetValue$4(paddingConfig, 'right', 0)
          };
          parent.childMargin.top = GetValue$4(paddingConfig, 'top', 0);
          parent.childMargin.bottom = GetValue$4(paddingConfig, 'bottom', 0);
        } else {
          childPadding = {
            top: GetValue$4(paddingConfig, 'top', 0),
            bottom: GetValue$4(paddingConfig, 'bottom', 0)
          };
      ...
      if (sliderConfig) {
        ...
        sliderPadding = GetValue$4(config, 'space.slider', 0);
        parent.hideUnscrollableSlider = GetValue$4(sliderConfig, 'hideUnscrollableSlider', false);
  ...
  var ScrollableBlock = /*#__PURE__*/function (_BaseSizer) {
    ...
    function ScrollableBlock(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setClampMode(GetValue$1(config, 'clamplChildOY', true));
